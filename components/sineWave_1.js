        ...
        <svg width="301" height="176" viewBox="0 0 301 176" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {whichHouse === '9' & planet === 'jupiter' ?
                <>
                    ...
                    <path d="M201.778 154.203C203.356 153.988 205.241 152.439 206.574 151.662C208.276 150.669 207.461 148.382 208.907 147.25C210.402 146.081 212.846 146.531 214.619 146.531C215.719 146.531 216.739 145.906 217.667 145.412C218.605 144.912 218.367 145.221 217.699 145.708C216.793 146.366 215.878 146.983 215.088 147.727C214.364 148.408 213.422 149.869 212.317 149.983C211.266 150.092 210.241 150.331 209.126 150.367C208.483 150.388 207.893 151.247 207.415 151.638C206.209 152.625 204.159 152.877 203.073 153.963" stroke="#D99848" stroke-opacity="0.68" strokeWidth="2" strokeLinecap="square" />
                    <path d="M209.067 149.983C210.323 149.9 211.726 149.195 212.591 148.329C213.723 147.198 212.11 148.563 211.417 148.891C210.924 149.125 210.35 149.36 209.789 149.36C208.845 149.36 210.013 148.47 210.191 148.113C210.587 147.321 212.142 147.777 212.807 147.777" stroke="#D96248" stroke-opacity="0.66" strokeWidth="2" strokeLinecap="square" />
                </> : (null)}
            ...
            {whichHouse === '12' & planet === 'jupiter' ?
                ...
                <>
                    ...
                    <path d="M271.778 107.203C273.356 106.988 275.241 105.439 276.574 104.662C278.276 103.669 277.461 101.382 278.907 100.25C280.402 99.0806 282.846 99.5307 284.619 99.5307C285.719 99.5307 286.739 98.906 287.667 98.4118C288.605 97.9123 288.367 98.2213 287.699 98.7075C286.793 99.3659 285.878 99.9833 285.088 100.727C284.364 101.408 283.422 102.869 282.317 102.983C281.266 103.092 280.241 103.331 279.126 103.367C278.483 103.388 277.893 104.247 277.415 104.638C276.209 105.625 274.159 105.877 273.073 106.963" stroke="#D99848" stroke-opacity="0.68" strokeWidth="2" strokeLinecap="square" />
                    <path d="M279.067 102.983C280.323 102.9 281.726 102.195 282.591 101.329C283.723 100.198 282.11 101.563 281.417 101.891C280.924 102.125 280.35 102.36 279.789 102.36C278.845 102.36 280.013 101.47 280.191 101.113C280.587 100.321 282.142 100.777 282.807 100.777" stroke="#D96248" stroke-opacity="0.66" strokeWidth="2" strokeLinecap="square" />
                </> : (null)}
            {/* ----- Saturn----------------- */}
